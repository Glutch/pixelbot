...
let beginDataProcessing = () => {
  ...
  setInterval(() => {
    this.info = {
      ...
      isHuntersMarked: isHuntersMarked,
      TargetIsOurs: TargetIsOurs,
      IsTargetElemental: IsTargetElemental,
      IsPetInRange: IsPetInRange,
      ComboPoints: ComboPoints,
      GetXPPct: GetXPPct,
      hasAspectHawk: hasAspectHawk,
      hasAspectCheetah: hasAspectCheetah,
      IsTargetTooHighLevel: IsTargetTooHighLevel,
      isPetDead: isPetDead,
      areBagsFull: areBagsFull,
      needAmmo: needAmmo,
      isTargetMob: isTargetMob,
      GetPetExists: GetPetExists,
      getPetHp: getPetHp,
      isPetSad: isPetSad,
      shielddebuff: shielddebuff,
  ...
  setInterval(() => {
    ...
    targetMaxHealth = reader.getIntAtCell(f[18])
    targetCurrentHealth = reader.getIntAtCell(f[19])

    // isHuntersMarked = reader.getIntAtCell(f[46])
    OutOfRange = reader.getIntAtCell(f[46])

    hasAspectHawk = reader.getIntAtCell(f[47])
    hasAspectCheetah = reader.getIntAtCell(f[48])
    IsTargetTooHighLevel = reader.getIntAtCell(f[49])
    GetPetExists = reader.getIntAtCell(f[50])
    isPetDead = reader.getIntAtCell(f[51])
    isTargetMob = reader.getIntAtCell(f[52])
    getPetHp = reader.getIntAtCell(f[55])
    TargetIsOurs = reader.getIntAtCell(f[56])
    IsTargetElemental = reader.getIntAtCell(f[57])
    IsPetInRange = reader.getIntAtCell(f[58])
    ComboPoints = reader.getIntAtCell(f[59])
    GetXPPct = reader.getIntAtCell(f[60])
    ...
    serpentsting = reader.getIntAtCell(f[43]) !== 0
    shielddebuff = reader.getIntAtCell(f[44]) !== 0
    ...
    isPetSad = reader.getIntAtCell(f[45])
  ...
  setInterval(() => {
    ...
    areBagsFull = reader.getIntAtCell(f[53])
    needAmmo = reader.getIntAtCell(f[54])
    ...
    for (let i = 17; i >= 0; i--) {
      ...
      switch (i) {
        ...
        case 13:
          ...
          break
        case 12:
          spell.powerwordshield.active = active
          break
        case 11:
          needFood = active
          break
